...
// Removendo Elementos
    ...
    let elementoRemovido = arr.pop("Boromir")  // Caso não saiba o ultimo valor pode usar arr.pop()
    console.log(arr)
    console.log(elementoRemovido)

    // shift: Remove um elemento no começo do array e devolve o elemento removido
    elementoRemovido = arr.shift("Boromir")  // Caso não saiba o primeiro valor pode usar arr.shift()
    console.log(arr)
    console.log(elementoRemovido)
